      ...
      <div className="text-center z-10 max-w-5xl mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
          <button
            ...
            className="flex items-center justify-center space-x-3 px-8 py-4 bg-primary text-primary-foreground font-semibold rounded-2xl apple-hover apple-shadow cyber-glow"
          >
        ...
        <div className="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 bg-chart-1/30 rounded-full animate-pulse delay-2000"></div>
      </div>
    </section>
  )
}
